                                        ...
                                        @if ($resumes->isNotEmpty())
                                            @foreach ($users_data as $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('resume.toggleStatus', $user['resume_id']) }}"
                                                            ...
                                                            @endphp
                                                            <button type="button"
                                                                class="btn btn-{{ $isPublic ? 'success' : 'danger' }}"
                                                                onclick="confirmToggleStatus('{{ $user['resume_id'] }}', {{ $isPublic ? 'true' : 'false' }})">
                                                        ...
                                                        <div class="action-dots">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('resume.view', ['id' => $user['resume_id'] ?? '']) }}"><i
                                                                ...
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('resume.downloadDoc', ['id' => $user['resume_id'] ?? '']) }}">
                                                                        <i class="fa fa-download" aria-hidden="true"></i>
                                                                        Download as DOC</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
