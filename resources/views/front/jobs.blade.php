                                        ...
                                        <div class="col-md-12">
                                            <div class="card border-0 p-3 shadow mb-4">
                                                <div class="card-body d-flex align-items-start">
                                                    @if ($job->image)
                                                        <div class="me-3">
                                                            <img src="{{ asset($job->image) }}" class="img-fluid" style="width: 120px; height: 120px; object-fit: cover;">
                                                        </div>
                                                    @endif
                                                    ...
                                                    <div class="text-end ms-3">
                                                        ...
                                                        <a href="{{ route('jobDetail', $job->id) }}" class="btn btn-outline-primary">Details</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
